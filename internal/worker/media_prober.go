...
var query_update_media_info = fmt.Sprintf(
	...
	torrent_stream.TableName,
	torrent_stream.Column.MediaInfo,
	torrent_stream.Column.UAt, db.CurrentTimestamp,
	torrent_stream.Column.Hash,
	torrent_stream.Column.Path,
	torrent_stream.Column.MediaInfo,
)
