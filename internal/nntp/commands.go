...
func (r *CmdResult) readCodeLineAndHeadersAndBody(expectCode int) (code int, message string, headers textproto.MIMEHeader, body io.ReadCloser, err error) {
	r.c.conn.StartResponse(r.id)
...
func (r *CmdResult) readCodeLineAndBody(expectCode int) (code int, message string, body io.ReadCloser, err error) {
	r.c.conn.StartResponse(r.id)
