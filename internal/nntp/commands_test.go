...
func TestListActiveTimes_NotConnected(t *testing.T) {
	client := NewClient(&ClientConfig{
		Host: "example.com",
	})

	groups, err := client.ListActiveTimes("")
	assert.Error(t, err, "ListActiveTimes()")
	assert.Nil(t, groups, "groups")
...
func TestListNewsGroups_NotConnected(t *testing.T) {
	client := NewClient(&ClientConfig{
		Host: "example.com",
	})

	groups, err := client.ListNewsGroups("")
	assert.Error(t, err, "ListNewsGroups()")
	assert.Nil(t, groups, "groups")
...
func TestListDistribPats_NotConnected(t *testing.T) {
	client := NewClient(&ClientConfig{
		Host: "example.com",
	})

	pats, err := client.ListDistribPats()
	assert.Error(t, err, "ListDistribPats()")
	assert.Nil(t, pats, "pats")
...
func TestGroup_NotConnected(t *testing.T) {
	client := NewClient(&ClientConfig{
		Host: "example.com",
	})
...
func TestArticle_NotConnected(t *testing.T) {
	client := NewClient(&ClientConfig{
		Host: "example.com",
	})
...
func TestHead_NotConnected(t *testing.T) {
	client := NewClient(&ClientConfig{
		Host: "example.com",
	})
...
func TestBody_NotConnected(t *testing.T) {
	client := NewClient(&ClientConfig{
		Host: "example.com",
	})
...
func TestStat_NotConnected(t *testing.T) {
	...
	_, _, err := client.Stat("<45223423@example.com>")
	assert.Error(t, err, "Stat()")
...
func TestOver_NotConnected(t *testing.T) {
	client := NewClient(&ClientConfig{
		Host: "example.com",
	})
...
func TestListGroup_NotConnected(t *testing.T) {
	client := NewClient(&ClientConfig{
		Host: "example.com",
	})

	_, err := client.ListGroup("misc.test", "")
	assert.Error(t, err, "ListGroup()")
...
func TestNext_NotConnected(t *testing.T) {
	client := NewClient(&ClientConfig{
		Host: "example.com",
	})
...
func TestLast_NotConnected(t *testing.T) {
	client := NewClient(&ClientConfig{
		Host: "example.com",
	})
