...
func TestFileTypeDetection(t *testing.T) {
	...
	t.Run("Get7zPartNumber", func(t *testing.T) {
		...
		for _, tc := range testCases {
			t.Run(tc.filename, func(t *testing.T) {
				result := Get7zPartNumber(tc.filename)
				assert.Equal(t, tc.expected, result)
			})
		}
	})
...
func TestInterpolationSearch(t *testing.T) {
	...
	t.Run("FindAtStart", func(t *testing.T) {
		...
		result, err := InterpolationSearch(ctx, 0, 10, 10000, getByteRange)
	...
	t.Run("FindInMiddle", func(t *testing.T) {
		...
		result, err := InterpolationSearch(ctx, 5500, 10, 10000, getByteRange)
		require.NoError(t, err)
	...
	t.Run("FindAtEnd", func(t *testing.T) {
		...
		result, err := InterpolationSearch(ctx, 9999, 10, 10000, getByteRange)
		require.NoError(t, err)
	...
	t.Run("SingleSegment", func(t *testing.T) {
		...
		result, err := InterpolationSearch(ctx, 500, 1, 1000, getByteRange)
		require.NoError(t, err)
		assert.Equal(t, 0, result.Index)
	...
	t.Run("ManySegments", func(t *testing.T) {
		...
		for _, pos := range testPositions {
			result, err := InterpolationSearch(ctx, pos, segmentCount, fileSize, getByteRange)
	...
	t.Run("ContextCancellation", func(t *testing.T) {
		...
		_, err := InterpolationSearch(ctx, 50000, 100, 100000, getByteRange)
		assert.Error(t, err)
	...
	t.Run("OutOfBoundsNegative", func(t *testing.T) {
		...
		_, err := InterpolationSearch(ctx, -1, 10, 10000, getByteRange)
		assert.Error(t, err)
	...
	t.Run("OutOfBoundsPositive", func(t *testing.T) {
		...
		_, err := InterpolationSearch(ctx, 10000, 10, 10000, getByteRange)
		assert.Error(t, err)
		assert.Contains(t, err.Error(), "out of bounds")
	})
	...
	t.Run("EmptySegmentList", func(t *testing.T) {
		...
		_, err := InterpolationSearch(ctx, 0, 0, 0, getByteRange)
		assert.Error(t, err)
...
func TestDirectFileStreaming(t *testing.T) {
	...
	t.Run("SingleSegmentFile", func(t *testing.T) {
		t.Skip("Skipped: depends on NNTP body reading which has known issues")
	})

	t.Run("MultiSegmentFile", func(t *testing.T) {
		t.Skip("Skipped: depends on NNTP body reading which has known issues")
	})
