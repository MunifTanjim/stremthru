...
func TestLanguages(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"EMPIRE STATE 2013 DVDRip TRNC English and Española Latin", []string{"english", "spanish"}},
	...
	for _, tc := range []struct {
		...
		{"not detect PT language from temporada season naming", "Castlevania 2017 1º temporada completa 1080p", nil},
		{"not detect PT language with cap. episode title", "City on a Hill - Temporada 1 [HDTV][Cap.110].avi", nil},
		{"not detect NL language from website", "La inocencia [720][wWw.EliteTorrent.NL].mkv", nil},
		{"not detect FI language from website", "Reasonable Doubt - Temporada 1 [HDTV][Cap.101][www.AtomoHD.FI]", nil},
		{"not detect FI language from website v2", "1883 - Temporada 1 [HDTV 720p][Cap.103][AC3 5.1][www.AtomoHD.fi]", nil},
		{"not detect TW language from website", "Los Winchester - Temporada 1 [HDTV][Cap.103][www.atomoHD.tw]", nil},
		{"not detect CH language from website", "El Inmortal- Temporada 1 [HDTV 720p][Cap.104][AC3 5.1][www.AtomoHD.ch]]", nil},
