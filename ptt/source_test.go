...
func TestSource(t *testing.T) {
	for _, tc := range []struct {
		...
		{"HDTVRip", "Rebecca.1940.720p.HDTVRip.HDCLUB", "HDTV"},
		...
		{"WEB-DLRip", "Звонок из прошлого / Kol / The Call (2020) WEB-DLRip | ViruseProject", "WEB-DL"},
		...
		{"WEB-DLRip", "Соперницы (Алексей Дмитриев) [1929, драма, WEB-DLRip]", "WEB-DL"},
