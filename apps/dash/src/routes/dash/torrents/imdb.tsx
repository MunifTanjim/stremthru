  ...
  return (
    <div className="space-y-4">
      ...
      <Sheet onOpenChange={setReviewModalOpen} open={reviewModalOpen}>
        <SheetContent className="flex max-h-screen w-full flex-col sm:max-w-2xl">
          <SheetHeader>
          ...
          <ScrollArea className="flex flex-col gap-2 overflow-hidden">
            {selectedTorrents.length > 1 && (
              <Field>
                <FieldLabel htmlFor="torrent-select">Select Torrent</FieldLabel>
                <Select
                  ...
                  <SelectContent>
                    {selectedTorrents.map((torrent) => (
                      <SelectItem key={torrent.hash} value={torrent.hash}>
                        <div className="max-w-md truncate">{torrent.name}</div>
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
            ...
            {currentReviewItem && currentTorrent && (
              <Form className="flex flex-col gap-4" form={reviewForm}>
                ...
                <reviewForm.AppField name="imdb_id">
                  {(field) => (
                    <field.Input label="IMDB ID" placeholder="tt1234567" />
                  )}
                </reviewForm.AppField>

                <reviewForm.AppField name="prev_imdb_id">
                  {(field) => <field.Input label="Previous IMDB ID" readOnly />}
                </reviewForm.AppField>
                ...
                <div className="flex justify-between border-t pt-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <reviewForm.SubmitButton variant="destructive">
                      Submit Review
